            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 text-slate-300">
                  ...
                  <span>support@wata-board.com</span>
                </div>
                ...
                <div className="flex items-center gap-3 text-slate-300">
                  ...
                  <span>Blockchain City, Stellar Network</span>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full h-11 rounded-xl border border-slate-800 bg-slate-950/50 px-4 text-sm text-slate-100 outline-none ring-sky-500/30 placeholder:text-slate-500 focus:ring-4"
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full h-11 rounded-xl border border-slate-800 bg-slate-950/50 px-4 text-sm text-slate-100 outline-none ring-sky-500/30 focus:ring-4"
                  required
                >
              ...
              <button
                type="submit"
                className="w-full h-11 rounded-xl bg-sky-500 px-5 text-sm font-semibold text-white shadow-lg shadow-sky-500/20 ring-1 ring-inset ring-white/10 transition hover:bg-sky-400 focus:outline-none focus:ring-4 focus:ring-sky-500/30"
              >
